 ...
 */
public class HorizontalAdapterTitledBackdrops extends BaseAdapter implements SectionIndexer {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = li.inflate(R.layout.widget_horizontal_boxset_tile_large, parent, false);
        ...
        if (selectedIndex == position) {
            holder.title.setText(mBaseItems.get(position).getName());
