...
import com.mb.android.playbackmediator.cast.reconnection.ReconnectionService;
 ...
 */
public abstract class BaseCastManager implements DeviceSelectionListener, GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener, OnFailedListener {
    ...
    /**
     * This is called from {@link com.mb.android.playbackmediator.cast.CastMediaRouterCallback}
...
//        }
    ...
    public void setDevice(MediaRouter.RouteInfo info) {
        mSelectedCastDevice = null;
        mDeviceName = info.getName();
    }
     ...
     *     {@link com.mb.android.playbackmediator.cast.callbacks.VideoCastConsumerImpl}
    ...
    public boolean isConnected() {
        ...
        boolean connected = (null != mApiClient) && mApiClient.isConnected();

        if (!connected) {
            // we may still be connected to a MediaBrowserRouteProvider
            if (getRouteInfo() != null
                    && getRouteInfo().supportsControlCategory(MediaBrowserRouteProvider.CATEGORY_MEDIA_BROWSER_ROUTE)
                    && getRouteInfo().isSelected()) {
                connected = true;
            }
        }
    ...
    public final String getCurrentDeviceId() {
        ...
        if (mSelectedCastDevice != null)
            id = mSelectedCastDevice.getDeviceId();
     ...
     * <li>FEATURE_LOCKSCREEN : turns on Lock Screen using {@link android.media.RemoteControlClient} in supported
     * versions (JB+)
     * </ul>
     *
     * @param capabilities
     ...
     *
     * @see com.mb.android.playbackmediator.cast.callbacks.BaseCastConsumerImpl
     * @param listener
     */
