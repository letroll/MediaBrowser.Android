 ...
 * {@link com.mb.android.playbackmediator.cast.VideoCastManager} by using the following pattern:<br/>
 *
 * <pre>
 ...
 * </pre>
 *
 * Then the {@link com.mb.android.playbackmediator.cast.VideoCastManager} will manage the behavior, including its state and metadata and
 * interactions.
 */
public class MiniController extends RelativeLayout implements IMiniController {
     ...
     * Clients can register the {@link com.mb.android.playbackmediator.cast.VideoCastManager} instance to be the default listener so it
    ...
    public void setIcon(Uri uri) {
        if (uri == null || (null != mIconUri && mIconUri.equals(uri))) {
            return;
        }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    bm = BitmapFactory.decodeResource(getResources(), R.drawable.default_video_landscape);
                }
